...
| [instrument_process_signal.json](instrument_process_signal.json) | 端到端综合场景：两台储罐主干线 + 三通分支到 `CustomModule` + 温度计/压力表信号线；覆盖 `InlineInstrument`、`SignalLine`、`CustomModule`。 |
